...
function Login() {
  ...
  {/* Login Card */}
  <div className="relative group bg-black/40 backdrop-blur-xl border border-cyan-500/30 rounded-2xl shadow-[0_0_20px_rgba(0,245,255,0.3)] h-[65vh] w-[40vw] p-8 flex flex-col items-center justify-center overflow-hidden animate-fadeIn">
    ...
    {/* Heading */}
    <h2 className="text-2xl font-bold text-white mb-6 z-10">Login to your account</h2>
    ...
    <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col gap-5 w-full max-w-sm relative z-10">
      ...
      <button
        type="submit"
        className="p-3 rounded-lg bg-gradient-to-r from-cyan-500 to-purple-500 text-white font-semibold hover:opacity-90 transition"
      >
        Login
      </button>
    </form>
