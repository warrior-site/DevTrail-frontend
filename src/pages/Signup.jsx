...
function Signup() {
  ...
  return (
    <div className="flex items-center justify-center min-h-screen px-4">
      {/* Signup Card */}
      <div className="relative group bg-black/40 backdrop-blur-xl border border-purple-500/30 rounded-2xl shadow-[0_0_20px_rgba(168,85,247,0.3)] w-full max-w-md md:max-w-2xl lg:max-w-3xl p-6 sm:p-8 flex flex-col items-center justify-center overflow-hidden animate-fadeIn">
        ...
        {/* Heading */}
        <h2 className="text-xl sm:text-2xl md:text-3xl font-bold text-white mb-6 z-10">
          Create an account
        </h2>
        ...
        <form
          ...
          className="flex flex-col gap-4 w-full max-w-sm sm:max-w-md relative z-10"
        >
        ...
        {/* Login redirect */}
        <p className="text-gray-300 text-sm mt-6 z-10 text-center">
